...
![docker-compose-test-screenshot.png](docker-compose-test-screenshot.png)
![kafka-topics-screenshot.png](kafka-topics-screenshot.png)
...
![event-service-k8s-logs-screenshot.png](event-service-k8s-logs-screenshot.png)

#### Шаг 3
Добавьте сюда скриншота вывода при вызове https://cinemaabyss.example.com/api/movies 
![movies-response-screenshot.png](movies-k8s-response-screenshot.png)
...
![helm-install-screenshot.png.png](helm-install-screenshot.png.png)
и вывода https://cinemaabyss.example.com/api/movies
![movies-k8s-response-screenshot.png](movies-k8s-response-screenshot.png)
...
Результат
![fortio-load-screenshot.png](fortio-load-screenshot.png)
...
![circuit-breaker-screenshot.png](circuit-breaker-screenshot.png)
